...
def main():
    ...
    kkt = Bird("fig/starship.png", 2.0, (900, 400))
    kkt_1 = Bird("fig/enemy1.png", 2.0, (900, 400))
    kkt_2 = Bird("fig/enemy2.png", 2.0, (900, 400))
                ...
                if len(beams) != 0:
                    for beam in beams:
                        ...
                        if bkd2.rct.colliderect(beam.rct):
                            ...
                            tkm.showinfo("すばらすぃ","やるやん。")
                            return
                if kkt_1.rct.colliderect(bkd.rct): #爆弾インスタンスのrect変数
                    tkm.showwarning("お前が殺した。","あなたが殺した。")
                    return
                if kkt_1.rct.colliderect(bkd2.rct): #爆弾インスタンスのrect変数
                    tkm.showwarning("お前が殺した。","あなたが殺した。")
                    return
                pg.display.update()
                clock.tick(1000)
